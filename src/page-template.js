...
module.exports = (templateData) => {
  ...
  // destructure projects and about data from templateDat base on their property keynames
    ...
    <body>
      <header>
        <div class ="container flex-row justify-space-between align-center py-3">
          ...
          <nav class="flex-row">
            <a class="ml-2 my-1 px-2 py-2 py-1 bg-secondary text-dark" href="https://github.com${
              header.github
            }">GitHub</a>
          </nav>
        </div>
